...
public class NoticeCrawlerService {
    ...
    public void checkMainNotice() {
        try {
            ...
            if (!noticeId.equals(lastNoticeId)) {
                ...
                notifyMainNoticeMembers(noticeInfo);
    ...
    // 3. noticeType이 MAIN인 멤버에게 메일 발송
    private void notifyMainNoticeMembers(String noticeInfo) {
        List<Member> mainNoticeMembers = memberRepository.findByNoticeTypeAndNoticeFlag("MAIN", true);
