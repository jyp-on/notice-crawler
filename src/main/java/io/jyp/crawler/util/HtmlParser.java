                        ...
                        <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0; text-align: center;">
                            <div style="max-width: 600px; margin: 50px auto; background: #fff; padding: 30px; border-radius: 10px; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); text-align: left;">
                                ...
                                <div style="text-align: center; padding-bottom: 20px; border-bottom: 1px solid #ddd; margin-top: 10px;">
                                    <h2 style="color: #4CAF50; font-family: Arial, sans-serif; font-size: 24px;">새로운 공지사항이 있습니다!</h2>
                                </div>
                               \s
                                <table style="border-collapse: collapse; width: 100%%; font-family: Arial, sans-serif; margin-top: 30px;">
                                    <tr>
                                        <th style="border: 1px solid #ddd; padding: 12px; text-align: left; background-color: #f9f9f9; color: #333;">제목</th>
                                        <td style="border: 1px solid #ddd; padding: 12px; color: #555;">%s</td>
                                    </tr>
                                    <tr>
                                        <th style="border: 1px solid #ddd; padding: 12px; text-align: left; background-color: #f9f9f9; color: #333;">URL</th>
                                        <td style="border: 1px solid #ddd; padding: 12px;">
                                            <a href="%s" style="text-decoration: none; color: #2196F3;">공지사항 바로가기</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="border: 1px solid #ddd; padding: 12px; text-align: left; background-color: #f9f9f9; color: #333;">작성자</th>
                                        <td style="border: 1px solid #ddd; padding: 12px; color: #555;">%s</td>
                                    </tr>
                                    <tr>
                                        <th style="border: 1px solid #ddd; padding: 12px; text-align: left; background-color: #f9f9f9; color: #333;">등록일</th>
                                        <td style="border: 1px solid #ddd; padding: 12px; color: #555;">%s</td>
                                    </tr>
                                </table>
                               \s
